...
function mapMatch(raw: any): Match {
  ...
  return {
    ...
    competitionEmblemUrl: raw.competition?.emblem ?? null,
    ...
    status,
    statusDetail: raw.status ?? null,
    elapsedMinutes: typeof raw.minute === 'number' ? raw.minute : null,
    injuryTimeMinutes: typeof raw.injuryTime === 'number' ? raw.injuryTime : null,
