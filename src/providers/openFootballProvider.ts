...
export const OPEN_FOOTBALL_COMPETITIONS: Array<{ code: string; name: string; country: string }> = [
  ...
  { code: 'en.3', name: 'League One', country: 'England' },
  { code: 'en.4', name: 'League Two', country: 'England' },
  { code: 'es.1', name: 'La Liga', country: 'Spain' },
  { code: 'es.2', name: 'La Liga 2', country: 'Spain' },
  { code: 'de.1', name: 'Bundesliga', country: 'Germany' },
  { code: 'de.2', name: '2. Bundesliga', country: 'Germany' },
  { code: 'it.1', name: 'Serie A', country: 'Italy' },
  { code: 'it.2', name: 'Serie B', country: 'Italy' },
  { code: 'fr.1', name: 'Ligue 1', country: 'France' },
  { code: 'fr.2', name: 'Ligue 2', country: 'France' },
  { code: 'nl.1', name: 'Eredivisie', country: 'Netherlands' },
  { code: 'pt.1', name: 'Primeira Liga', country: 'Portugal' },
  { code: 'be.1', name: 'First Division A', country: 'Belgium' },
  { code: 'tr.1', name: 'Süper Lig', country: 'Turkey' },
  { code: 'at.1', name: 'Bundesliga', country: 'Austria' },
  { code: 'sc.1', name: 'Premiership', country: 'Scotland' },
  { code: 'gr.1', name: 'Super League', country: 'Greece' },
  { code: 'ru.1', name: 'Premier League', country: 'Russia' },
  { code: 'mls.1', name: 'MLS', country: 'United States' },
  { code: 'br.1', name: 'Série A', country: 'Brazil' },
  { code: 'ar.1', name: 'Primera División', country: 'Argentina' },
  { code: 'mx.1', name: 'Liga MX', country: 'Mexico' },
];
