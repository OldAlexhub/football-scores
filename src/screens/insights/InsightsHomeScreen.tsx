  ...
  return (
    <ScreenContainer>
      <SafeScrollView contentBottomPadding={20}>
        ...
        <Card style={[styles.card, styles.newsCard]}>
          <Text
            style={[styles.newsLink, { color: theme.colors.textPrimary }]}
        ...
        {favoriteCompetitions.length === 0 ? (
          <Card style={styles.card}>
            <Text style={{ color: theme.colors.textMuted }}>{t('matchday.selectFavoriteCompetitions')}</Text>
          </Card>
        ) : (
...
const styles = StyleSheet.create({
  ...
  newsCard: { paddingVertical: 4 },
  newsLink: { fontSize: 16, fontWeight: '700', paddingVertical: 8 },
